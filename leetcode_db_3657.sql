...
-- link to problem is : https://leetcode.com/problems/find-loyal-customers/description/
...
SELECT 
      ...
      ,max(transaction_date) - min(transaction_date) active_time
      ,(
...
WHERE 
       round((refund_transactions/number_of_transactions)*100,2) < 20
