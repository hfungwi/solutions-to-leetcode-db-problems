...
-- link to problem is : https://leetcode.com/problems/find-products-with-valid-serial-numbers/description/
...
FROM   products
WHERE REGEXP_LIKE(description, '(^|[^0-9A-Za-z])SN\d{4}-\d{4}([^0-9A-Za-z-]|$)')
ORDER BY 1
--End of Solution
