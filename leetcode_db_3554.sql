...
-- link to problem is : https://leetcode.com/problems/find-category-recommendation-pairs/
...
--Start of Solution
SELECT
    pi1.category               category1,
    pi2.category               category2,
    COUNT(DISTINCT p2.user_id) customer_count
FROM
         productpurchases p1
...
GROUP BY
    ...
    pi2.category
HAVING
    COUNT(DISTINCT p2.user_id) >= 3
ORDER BY
    COUNT(DISTINCT p2.user_id) DESC,
    pi1.category ASC,
    pi2.category ASC
--End of Solution
